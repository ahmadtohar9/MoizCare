...
<div class="px-6 py-4 flex flex-col gap-1">
    <div
        class="flex items-center gap-2 text-xs font-medium text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wide">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4">
        <div class="flex flex-col">
            <h1 class="text-[#111418] dark:text-white text-3xl font-black leading-tight tracking-tight">Employee
                Directory</h1>
            <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Central database for all staff members at Moiz
                Care.</p>
        </div>
        <button onclick="openModal()"
            class="flex items-center gap-2 bg-primary hover:bg-primary/90 text-white px-5 py-2.5 rounded-lg font-bold text-sm transition-all shadow-md active:scale-95">
...
<div class="px-6 pb-10">
    <div
        class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-[#e5e7eb] dark:border-[#2d3748] overflow-hidden p-4">
...
<div id="employeeModal" class="hidden fixed inset-0 z-40 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
    aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <!-- Header -->
            <div
                class="bg-white dark:bg-gray-800 px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                <h3 class="text-xl font-bold text-gray-900 dark:text-white" id="modal-title">Form Data Pegawai</h3>
                <button onclick="closeModal()" class="text-gray-400 hover:text-gray-500 max-w-[20px]"><span
            ...
            <div class="bg-gray-50 dark:bg-gray-700/50 px-6 pt-4 border-b border-gray-200 dark:border-gray-600">
                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                    <button onclick="switchTab('tab-profile')" id="btn-tab-profile"
                    ...
                    <button onclick="switchTab('tab-personal')" id="btn-tab-personal"
                        ...
                        <span class="material-symbols-outlined align-bottom mr-1 text-[18px]">id_card</span> Data
                        Pribadi
                    </button>
                    <button onclick="switchTab('tab-employment')" id="btn-tab-employment"
                        class="tab-btn border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                        <span class="material-symbols-outlined align-bottom mr-1 text-[18px]">badge</span> Kepegawaian
                    </button>
                    <button onclick="switchTab('tab-family')" id="btn-tab-family"
                        class="tab-btn border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm hidden"
                        id="family-tab-head">
                        <span class="material-symbols-outlined align-bottom mr-1 text-[18px]">diversity_3</span>
                        Keluarga
                    </button>
                </nav>
            </div>
                ...
                <form id="employeeForm" class="space-y-6">
                    ...
                    <div id="tab-profile" class="tab-content">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Photo Upload -->
                            <div
                                class="md:col-span-2 flex items-center gap-4 p-4 border rounded-lg bg-gray-50 border-dashed border-gray-300">
                                <div
                                    class="shrink-0 size-20 rounded-full bg-gray-200 overflow-hidden border border-gray-300">
                                    <img id="preview-photo"
                                        src="https://ui-avatars.com/api/?name=User&background=random"
                                        class="w-full h-full object-cover">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Foto
                                        Profil</label>
                                    <input type="file" name="photo" accept="image/*" onchange="previewImage(this)"
                                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-primary file:text-white hover:file:bg-primary/90">
                                    <p class="text-[10px] text-gray-500 mt-1">Format: JPG/PNG, Max 2MB. Rasio 1:1.</p>
                                </div>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">NIP / ID
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nama Lengkap
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Departemen
                                    <span class="text-red-500">*</span></label>
                                <select name="unit_id"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary/20 sm:text-sm"
                                    required>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Jabatan <span
                    ...
                    <div id="tab-personal" class="tab-content hidden">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">NIK
                                    (KTP)</label>
                                <input type="text" name="nik"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary/20 sm:text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nama Ibu
                                    Kandung</label>
                                <input type="text" name="mothers_name"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary/20 sm:text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tempat
                                    Lahir</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            <div>
                                ...
                                <textarea name="address_ktp" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary/20 sm:text-sm"></textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Alamat
                                    Domisili <span class="text-xs text-gray-500">(Kosongkan jika sama)</span></label>
                                <textarea name="address_domicile" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary/20 sm:text-sm"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab-employment" class="tab-content hidden">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">BPJS
                                    Kesehatan</label>
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200">
                            <h4 class="text-sm font-bold text-red-500 uppercase tracking-wide mb-4">Pengakhiran Kerja
                                (Khusus Keluar)</h4>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-red-50 p-4 rounded-lg">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Tanggal Keluar
                                        (Resign)</label>
                                    <input type="date" name="resign_date"
                                        class="mt-1 block w-full rounded-md border-red-300 shadow-sm focus:border-red-500 focus:ring focus:ring-red-200 sm:text-sm">
                                </div>
                                <div class="md:col-span-2">
                                    <label class="block text-sm font-medium text-gray-700">Alasan Keluar</label>
                                    <textarea name="resign_reason" rows="2"
                                        class="mt-1 block w-full rounded-md border-red-300 shadow-sm focus:border-red-500 focus:ring focus:ring-red-200 sm:text-sm"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab-family" class="tab-content hidden">
                        ...
                        <div id="family-container" class="hidden">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <button type="button" onclick="openFamilyForm()"
                                    class="text-sm bg-primary text-white px-3 py-1.5 rounded-lg flex items-center gap-1">
                            ...
                            <div id="familyFormBox" class="mt-6 p-4 border rounded-lg bg-gray-50 hidden">
                                <div class="flex justify-between items-center mb-3">
                                    ...
                                    <button onclick="resetFamilyForm()" id="fam_btn_cancel" type="button"
                                        class="text-xs text-red-500 underline hidden">Batal Edit</button>
                                </div>
                                <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
                                    <input type="hidden" id="fam_id">
                                    <input type="text" id="fam_name" placeholder="Nama Lengkap"
                                    ...
                                    <input type="text" id="fam_edu" placeholder="Pendidikan"
                                        class="rounded border-gray-300 text-sm">
                                    <input type="text" id="fam_job" placeholder="Pekerjaan"
                                        class="rounded border-gray-300 text-sm">
                                    ...
                                    <button type="button" onclick="submitFamily()" id="fam_btn_submit"
                                        class="bg-green-600 text-white rounded font-bold">Simpan</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Footer Actions -->
            <div
                class="bg-gray-50 dark:bg-gray-700 px-6 py-4 flex flex-row-reverse border-t border-gray-200 dark:border-gray-600">
                <button type="button" onclick="submitForm()"
                    class="w-full inline-flex justify-center rounded-lg border border-transparent shadow-sm px-5 py-2.5 bg-primary text-base font-bold text-white hover:bg-primary/90 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm">
                    Simpan Data Pegawai
                </button>
                <button type="button" onclick="closeModal()"
                    class="mt-3 w-full inline-flex justify-center rounded-lg border border-gray-300 shadow-sm px-5 py-2.5 bg-white text-base font-bold text-gray-700 hover:bg-gray-50 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                    Batal
                </button>
            </div>
        </div>
...
<div id="viewModal" class="fixed inset-0 z-[60] hidden overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-4 py-6">
        ...
        <div
            class="relative bg-white rounded-3xl shadow-2xl w-full max-w-5xl overflow-hidden transform transition-all border border-gray-100">

            <!-- Modal Header (White & Clean) -->
            <div class="p-8 border-b border-gray-100 relative">
                <button onclick="closeViewModal()"
                    class="absolute top-6 right-6 text-gray-400 hover:text-gray-600 transition-all">
                ...
                <div class="flex flex-col md:flex-row items-center md:items-start gap-6">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute -bottom-2 -right-2 size-6 bg-green-500 border-4 border-white rounded-full">
                        </div>
                    </div>
                    ...
                    <div class="flex-1 text-center md:text-left pt-2">
                        <div class="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-2">
                            <h2 id="view_name" class="text-3xl font-black text-gray-900 tracking-tight">Nama Pegawai
                            </h2>
                            <span id="view_status_badge"
                                class="px-3 py-1 rounded-lg bg-green-100 text-green-700 text-[10px] font-black uppercase tracking-widest">ACTIVE</span>
                        </div>
                        <div
                            class="flex flex-wrap justify-center md:justify-start items-center gap-y-1 gap-x-4 text-sm font-medium text-gray-500">
                    ...
                    <div class="flex items-end gap-3 pb-2">
                        <button onclick="editFromView()"
                            class="flex items-center gap-2 px-5 py-2.5 rounded-xl border border-gray-200 bg-white text-gray-700 font-bold text-sm hover:bg-gray-50 transition-all shadow-sm">
                            <span class="material-symbols-outlined text-lg">edit</span>
                            Edit Profile
                        </button>
                        <button onclick="printEmployeePdf()"
                            class="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 text-white font-bold text-sm hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20">
            ...
            <div class="px-8 border-b border-gray-100 bg-gray-50/50">
                <nav class="flex gap-8">
                    <button onclick="switchViewTab('profile')" id="view_btn_profile"
                        class="px-2 py-4 border-b-2 border-blue-600 text-blue-600 font-bold text-sm flex items-center gap-2 transition-all">
                        <span class="material-symbols-outlined text-lg">person</span> Profil
                    </button>
                    <button onclick="switchViewTab('berkas')" id="view_btn_berkas"
                        class="px-2 py-4 border-b-2 border-transparent text-gray-500 font-bold text-sm flex items-center gap-2 hover:text-gray-700 transition-all">
                        <span class="material-symbols-outlined text-lg">folder_open</span> Berkas
                    </button>
                    <button onclick="switchViewTab('absensi')" id="view_btn_absensi"
                        class="px-2 py-4 border-b-2 border-transparent text-gray-500 font-bold text-sm flex items-center gap-2 hover:text-gray-700 transition-all">
                        <span class="material-symbols-outlined text-lg">calendar_today</span> Absensi
                    </button>
                    <button onclick="switchViewTab('jadwal')" id="view_btn_jadwal"
                        class="px-2 py-4 border-b-2 border-transparent text-gray-500 font-bold text-sm flex items-center gap-2 hover:text-gray-700 transition-all">
            ...
            <div class="p-10 min-h-[500px]">
                ...
                <div id="view_tab_profile" class="view-tab-content">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
                        ...
                        <div>
                            <h4
                                class="flex items-center gap-2 font-black text-blue-600 mb-8 uppercase tracking-widest text-xs">
                            ...
                            <div class="grid grid-cols-2 gap-y-8 gap-x-6">
                                ...
                                <div class="col-span-1">
                                    <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">NIK
                                    </p>
                    ...
                    <!-- Footer Info Area -->
                    <div
                        class="mt-12 p-4 bg-gray-50 rounded-xl border border-gray-100 flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <span class="material-symbols-outlined text-gray-400">info</span>
                            <p class="text-xs font-bold text-gray-500">Last updated by Admin on <span
                                    id="view_updated_at"><?= date('M d, Y') ?></span></p>
                        </div>
                        <button class="text-xs font-black text-blue-600 uppercase hover:underline">View History
                            Logs</button>
                    </div>
                </div>
                ...
                <div id="view_tab_berkas" class="view-tab-content hidden">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            <h4 class="font-black text-gray-900 border-l-4 border-blue-600 pl-3">Daftar Dokumen Digital
                            </h4>
                            <p class="text-xs text-gray-500 mt-1">Klik pada dokumen untuk melihat atau mengunduh.</p>
                        </div>
                        <button id="btn_manage_docs"
                            class="text-xs font-black text-blue-600 border border-blue-600 px-4 py-2 rounded-lg hover:bg-blue-600 hover:text-white transition-all">
                            KELOLA SEMUA BERKAS
                        </button>
                    </div>
                ...
                <div id="view_tab_absensi" class="view-tab-content hidden">
                    <div class="mb-8">
                        <h4 class="font-black text-gray-900 border-l-4 border-blue-600 pl-3">Riwayat Kehadiran (30 Hari
                            Terakhir)</h4>
                ...
                <div id="view_tab_jadwal" class="view-tab-content hidden">
                    <div class="mb-8">
                        ...
                        <p class="text-xs text-gray-500 mt-1">Menampilkan jadwal dari 7 hari lalu hingga 14 hari ke
                            depan.</p>
                    </div>
                    <div class="overflow-hidden border border-gray-100 rounded-2xl">
...
<script>
    ...
    function deleteEmployee(id) {
        Swal.fire({
            ...
            text: "Data pegawai dan akses login akan dihapus secara permanen!",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?= base_url("employee/delete_employee/") ?>' + id,
                    type: 'POST',
                    dataType: 'json',
